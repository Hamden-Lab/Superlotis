...
typedef enum PicamError
{
    ...
    PicamError_OnlyDemoSupported                     = 55,
    /*------------------------------------------------------------------------*/
...
typedef enum PicamModel
{
    ...
    /* LANSIS 424 Series -----------------------------------------------------*/
    PicamModel_Lansis424Series           = 2711,
    PicamModel_LansisD424B               = 2712,
    PicamModel_LansisD424BX              = 2713,
    PicamModel_LansisD424BX_2            = 2714
    /*------------------------------------------------------------------------*/
} PicamModel;
/*----------------------------------------------------------------------------*/
