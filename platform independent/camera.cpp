...
int set_shutter(piint mode)
{
    ...
    switch (mode) {
        case 1:
            ...
            printf("Setting shutter mode normal\n");
            break;
        case 2:
            shutterDescription = "always closed";
            printf("Setting shutter mode closed\n");

            // printf("closed: ");
            break;
        case 3:
            shutterDescription = "always open";
            printf("Setting shutter mode open\n");

            // printf("open: ");
            break;
        case 4:
            shutterDescription = "open before trigger";
            printf("Setting shutter mode open before trigger\n");
